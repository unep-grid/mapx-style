...
Usage:
  uv run skills/build_bathymetry.py
  uv run skills/build_bathymetry.py --version 1       # bump version → layers/bathymetry__v1.pmtiles
  uv run skills/build_bathymetry.py --no-upload        # convert only, keep file at --out path
  uv run skills/build_bathymetry.py --out /data/bath.pmtiles  # custom output path
