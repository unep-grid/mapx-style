...
Usage:
  uv run skills/build_borders.py
  uv run skills/build_borders.py --version 1       # bump version → layers/mapx_borders__v1.pmtiles
  uv run skills/build_borders.py --no-upload        # generate only, keep file at --out path
  uv run skills/build_borders.py --out /data/borders.pmtiles  # custom output path
