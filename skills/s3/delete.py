...
Usage:
  uv run skills/s3/delete.py <s3_key>             # delete a single object
  uv run skills/s3/delete.py <prefix> --prefix    # delete all under prefix
  uv run skills/s3/delete.py glyphs/Roboto --prefix --yes  # skip confirmation

Examples:
  uv run skills/s3/delete.py layers/old_borders__v0.pmtiles
  uv run skills/s3/delete.py style/prod/assets/glyphs/Noto_Sans_Arabic --prefix
"""
