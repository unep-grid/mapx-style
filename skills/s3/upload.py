...
Usage:
  uv run skills/s3/upload.py <local_path> [s3_key] [--type TYPE] [--public]
                             [--name NAME] [--description DESC]

Examples:
  uv run skills/s3/upload.py ~/data/world.pmtiles maps/world.pmtiles --type pmtiles --public
  uv run skills/s3/upload.py countries.geojson geodata/countries.geojson --public
"""
