...
Usage:
  uv run scripts/s3/stream_upload_progress.py                  # auto-detect state file
  uv run scripts/s3/stream_upload_progress.py --watch          # refresh every 10s
  uv run scripts/s3/stream_upload_progress.py --watch 30       # refresh every 30s
  uv run scripts/s3/stream_upload_progress.py <state_file>     # explicit path
"""
