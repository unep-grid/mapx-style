...
Usage:
  uv run scripts/build_mask.py
  uv run scripts/build_mask.py --version 1     # → masks/un_2020_countries_mask__v1.geojson
  uv run scripts/build_mask.py --no-upload     # validate only, skip S3
