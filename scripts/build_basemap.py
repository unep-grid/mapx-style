...
Usage:
  ...
  uv run scripts/build_basemap.py --date 20260323   # specific Protomaps build date
  uv run scripts/build_basemap.py --version 1       # bump version → layers/protomaps_basemap__v1.pmtiles
