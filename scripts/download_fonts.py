...
Usage:
  uv run scripts/download_fonts.py                    # download all families
  uv run scripts/download_fonts.py --dir Noto_Sans    # one directory only
  uv run scripts/download_fonts.py --dry-run          # list files without downloading
